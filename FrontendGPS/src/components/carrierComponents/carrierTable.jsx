        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75 p-4 md:p-8">
                    {/* Contenido del modal */}
                    <div id="editUserModal" tabIndex="-1" aria-hidden="true" className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-center ${isModalOpen ? '' : 'hidden'} w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
